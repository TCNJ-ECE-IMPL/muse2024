...
train_ds = train_ds.batch(batch_size=25, drop_remainder=True)

valid_ds = tf.data.Dataset.from_tensor_slices((x_valid, y_valid))
valid_ds = valid_ds.batch(batch_size=25, drop_remainder=True)

test_ds = tf.data.Dataset.from_tensor_slices((x_test, y_test))
test_ds = test_ds.batch(batch_size=25, drop_remainder=True)
